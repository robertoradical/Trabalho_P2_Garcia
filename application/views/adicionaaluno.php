...
<main id="content">
    <div class="container">
        ...
        <br>
        <div class="well">
            <form class="form-horizontal" action="/index.php/Controleadmin/doPostaluno"
            method="POST">
                ...
                <div class="form-group">
                    <label for="ra" class="col-sm-2 control-label">
                        R.A:
                    </label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    <label for="ciclo" class="col-sm-2 control-label">
                        Ciclo:
                    </label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control"  min="1" max="6" name="ciclo" id="ciclo" required>
                    </div>
                </div>
                <div class="form-group">

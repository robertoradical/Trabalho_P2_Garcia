...
<head>
    ...
    <title>
        Biblioteca do Saber | Institucional
    </title>
...
<main id="content">
    <div class="container">
        ...
        <hr>
        <p>
            Para acessar a conta é preciso ter um cadastro, O cadastro é feito apenas
            fisicamente com um de nossos funcionarios. Para mais informações
            <a href="duvida">Clique aqui</a>
        </p>
    </div>
</main>
<footer>
